...
class CalendarAgent:
    ...
    #
    #     if start_str:
    #         start_dt = _parse_rfc3339(start_str, tz_name)
    #         patch.setdefault("start", {})["dateTime"] = start_dt.isoformat()
    #         patch["start"]["timeZone"] = tz_name
    #
    #     if end_str:
    #         end_dt = _parse_rfc3339(end_str, tz_name)
    #         patch.setdefault("end", {})["dateTime"] = end_dt.isoformat()
    #         patch["end"]["timeZone"] = tz_name
    #
    #     updated = await self.service.update_event(
    #         access_token=access_token,
    #         calendar_id=calendar_id,
